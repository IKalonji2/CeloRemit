...
def create_user_account(username, api_key):
    ...
    payload = "{\"currency\":\"VC_cUSD\",\"customer\":{\"accountingCurrency\":\"USD\",\"customerCountry\":\"SA\",\"externalId\":\""+username+"\",\"providerCountry\":\"US\"},\"compliant\":false,\"accountCode\":\"TRANSACTIONAL_ACCOUNT\",\"accountingCurrency\":\"USD\",\"accountNumber\":\""+str(account_number)+"\"}"    
    headers = {
